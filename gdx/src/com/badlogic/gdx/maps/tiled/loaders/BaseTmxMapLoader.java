...
public abstract class BaseTmxMapLoader<P extends BaseTmxMapLoader.Parameters> extends AsynchronousAssetLoader<TiledMap, P> {
	...
	public abstract TiledMap load (String fileName, P parameters);
	
	@Override
	public TiledMap loadSync (AssetManager manager, String fileName, FileHandle file, P parameters) {
		return map;
	}
	 ...
	 * @param map
	 * @param element */
	protected void loadLayer (TiledMap map, Element element) {
